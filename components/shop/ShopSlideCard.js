...
const ShopSlideCard = ({ item, addToWishlist }) => {
    const slugify = (value) =>
        (value || "")
            .toString()
            .trim()
    ...
    return (
        <div className="tpproduct tpproductitem mb-15 p-relative">
            ...
            <div className="tpproduct__content-area">
                <h3 className="tpproduct__title mb-5"><Link href={productHref}>{item.title}</Link></h3>
            ...
            <div className="tpproduct__ratingarea">
                <div className="d-flex align-items-center justify-content-between">
                    <div className="tpproductdot">
                        {(item?.color?.length ? item.color.slice(0, 6) : []).map((c, idx) => (
                            <Link
