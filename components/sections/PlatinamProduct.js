                                ...
                                <SwiperSlide key={i}>
                                    <div className="tpratingitem tpproduct text-center">
                                        <div className="tpproduct__thumb p-relative">
                                            <Link href={`/shop/${item?.slug || slugify(item?.title) || String(item?.id || "")}`}>
                                            ...
                                            <div className="tpproduct__thumb-action">
                                                <Link href="#" onClick={(e) => e.preventDefault()}><i className="fal fa-shopping-basket" /></Link>
                                        ...
                                        <div className="tpratingitem__content">
                                            <h4 className="tpratingitem__title mb-5">  <Link href={`/shop/${item?.slug || slugify(item?.title) || String(item?.id || "")}`}>Miko: Bold Miranda Joggers</Link></h4>
                                            <span>$31.00</span>
