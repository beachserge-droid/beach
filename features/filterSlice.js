...
export const filterSlice = createSlice({
    ...
    reducers: {
        ...
        addParentCategory: (state, { payload }) => {
            state.shopList.parentCategory = payload ? [payload] : []
        },
        clearParentCategory: (state) => {
            state.shopList.parentCategory = []
        },

        addSizeCategory: (state, { payload }) => {
            state.shopList.sizeCategory = payload ? [payload] : []
        },
        clearSizeCategory: (state) => {
            state.shopList.sizeCategory = []
        },
