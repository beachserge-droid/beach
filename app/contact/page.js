...
export const metadata = {
    ...
    description: "Ninico ile iletişime geçin. Sorularınız, önerileriniz ve teknik destek için bize ulaşabilirsiniz.",
    keywords: ["iletişim", "destek", "müşteri hizmetleri", "iletişim formu"],
    alternates: {
        canonical: "/contact",
    },
    openGraph: {
